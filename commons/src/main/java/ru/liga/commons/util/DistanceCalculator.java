...
public class DistanceCalculator {
    ...
    public double calculator(String coordinateCourier, String coordinateLocation) {
        double latitudeCoordinateCourier = Double.parseDouble(coordinateCourier
                .substring(1, coordinateCourier.indexOf(',')));
        double longitudeCoordinateCourier = Double.parseDouble(coordinateCourier
                .substring(coordinateCourier.indexOf(',') + 1, coordinateCourier.length() - 1));
        double latitudeCoordinateLocation = Double.parseDouble(coordinateLocation
                .substring(1, coordinateLocation.indexOf(',')));
        double longitudeCoordinateLocation = Double.parseDouble(coordinateLocation
                .substring(coordinateLocation.indexOf(',') + 1, coordinateLocation.length() - 1));
        double distance = calculator(
                latitudeCoordinateCourier,
                longitudeCoordinateCourier,
                latitudeCoordinateLocation,
                longitudeCoordinateLocation);
        return distance;
    }

    public double calculator(double latitudeCoordinateCourier,
