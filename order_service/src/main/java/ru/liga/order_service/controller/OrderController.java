...
public class OrderController {
    ...
    public ResponseEntity<Object> getAllOrderByCustomerId(@PathVariable("customer_id") Long id) {
        return ResponseEntity
    ...
    @GetMapping("/status")
    public ResponseEntity<Object> getAllOrderByStatus(@RequestParam("status") StatusOrders status) {
        return ResponseEntity
    ...
    public ResponseEntity<Object> getOrderByRestaurantID(@PathVariable("restaurant_id") Long restaurant_id) {
        return ResponseEntity
    ...
    public ResponseEntity<Object> updateOrderById(@PathVariable("id") Long id, @RequestBody OrderDto order) {
        return ResponseEntity
    ...
    public ResponseEntity<Object> updateOrderStatusById(@PathVariable("id") Long id, @RequestParam("status") StatusOrders status) {
        return ResponseEntity
